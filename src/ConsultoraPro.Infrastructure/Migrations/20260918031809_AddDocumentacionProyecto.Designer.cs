...
namespace ConsultoraPro.Infrastructure.Migrations
{
    ...
    [Migration("20260918031809_AddDocumentacionProyecto")]
    partial class AddDocumentacionProyecto
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ConsultoraPro.Domain.Models.AmbienteCloudResource", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.HasIndex("AmbienteId", "Activo");

                    b.ToTable("AmbienteCloudResources");
                });

            modelBuilder.Entity("ConsultoraPro.Domain.Models.AmbienteComponente", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("AmbienteComponentes");
                });

            modelBuilder.Entity("ConsultoraPro.Domain.Models.AmbienteTestUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.Property<string>("RolAplicacion")
                        .IsRequired()
                        .HasMaxLength(80)
                        .HasColumnType("varchar(80)");
            ...
            modelBuilder.Entity("ConsultoraPro.Domain.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<int?>("CumpleanosDia")
                        .HasColumnType("int");

                    b.Property<int?>("CumpleanosMes")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ConsultoraPro.Domain.Models.CarpetaDocumento", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.HasIndex("ProyectoId", "ParentId");
            ...
            modelBuilder.Entity("ConsultoraPro.Domain.Models.CorreoPendiente", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.Property<DateTime>("ProgramadoPara")
                        .HasColumnType("datetime(6)");
                    ...
                    b.HasIndex("Estado", "ProgramadoPara");

                    b.HasIndex("UsuarioId", "DedupKey", "Estado");
            ...
            modelBuilder.Entity("ConsultoraPro.Domain.Models.Credencial", b =>
                {
                    ...
                    b.Property<string>("SecretosExtraCifrado")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("ConsultoraPro.Domain.Models.Despliegue", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.Property<Guid>("EjecutadoPorId")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("ConsultoraPro.Domain.Models.Documento", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("ConsultoraPro.Domain.Models.DocumentoEtiqueta", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.HasIndex("DocumentoId", "Nombre")
                        .IsUnique();

                    b.ToTable("DocumentoEtiquetas");
                });

            modelBuilder.Entity("ConsultoraPro.Domain.Models.DocumentoVersion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("ConsultoraPro.Domain.Models.Notificacion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("ConsultoraPro.Domain.Models.PreferenciaNotificacion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");

                    b.Property<bool>("EnApp")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("tinyint(1)")
                        .HasDefaultValue(true);

                    b.Property<bool>("PorCorreo")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("tinyint(1)")
                        .HasDefaultValue(true);
            ...
            modelBuilder.Entity("ConsultoraPro.Domain.Models.Repositorio", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.Property<string>("EstadoPipeline")
                        .IsRequired()
                        .HasMaxLength(30)
                        .HasColumnType("varchar(30)");
                    ...
                    b.Property<string>("RamaPrincipal")
                        .IsRequired()
                        .HasMaxLength(120)
                        .HasColumnType("varchar(120)");
            ...
            modelBuilder.Entity("ConsultoraPro.Domain.Models.Screenshot", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("ConsultoraPro.Domain.Models.CarpetaDocumento", b =>
                {
                    b.HasOne("ConsultoraPro.Domain.Models.CarpetaDocumento", "Parent")
            ...
            modelBuilder.Entity("ConsultoraPro.Domain.Models.Despliegue", b =>
                {
                    b.HasOne("ConsultoraPro.Domain.Models.Ambiente", "Ambiente")
                        .WithMany("Despliegues")
                        .HasForeignKey("AmbienteId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("ConsultoraPro.Domain.Models.ApplicationUser", "EjecutadoPor")
                        .WithMany()
            ...
            modelBuilder.Entity("ConsultoraPro.Domain.Models.Documento", b =>
                {
                    b.HasOne("ConsultoraPro.Domain.Models.ApplicationUser", "ActualizadoPor")
                        .WithMany()
                        .HasForeignKey("ActualizadoPorId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("ConsultoraPro.Domain.Models.CarpetaDocumento", "Carpeta")
                        .WithMany()
            ...
            modelBuilder.Entity("ConsultoraPro.Domain.Models.DocumentoEtiqueta", b =>
                {
                    b.HasOne("ConsultoraPro.Domain.Models.Documento", "Documento")
                        .WithMany("Etiquetas")
            ...
            modelBuilder.Entity("ConsultoraPro.Domain.Models.Ambiente", b =>
                {
                    b.Navigation("CloudResources");

                    b.Navigation("Componentes");

                    b.Navigation("Credenciales");

                    b.Navigation("Despliegues");
